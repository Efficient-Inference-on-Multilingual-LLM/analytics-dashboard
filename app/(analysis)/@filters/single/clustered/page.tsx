...
const ClusteredHeatmapFilter = () => {
  const [urlState, setUrlState] = useIndividualHeatmapUrlState();
  ...
  return (
    <Section title="Clustered Heatmap Filter">
      <MethodSelector
...
export default ClusteredHeatmapFilter;
