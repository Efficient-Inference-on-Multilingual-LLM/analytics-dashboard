    ...
    pages: [
      {
        ...
        desc: "One config, raw matrix",
      },
      {
        href: "/single/ranked",
        label: "Ranked Heatmap",
        desc: "Sorted by similarity",
      },
      {
        href: "/single/clustered",
    ...
    pages: [
      {
        ...
        desc: "Per-layer cluster metrics",
      },
    ],
  },
];
          ...
          <NavigationMenu key={group.label}>
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuTrigger
                  className={
                    "text-lg font-medium" + (isActive ? " font-bold" : "")
                  }
                >
                  {group.label}
                </NavigationMenuTrigger>
